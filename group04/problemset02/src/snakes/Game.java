...
public class Game {
	...
	public void setSquareToRollAgain(int position) {
		this.setSquare(position, new RollAgain(this, position));
	}

	public void setSquareToSlowDown(int position) {
		this.setSquare(position, new SlowDown(this, position));
	}
